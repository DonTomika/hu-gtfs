...
osmosis \
    --read-pbf "$OSMFILE" outPipe.0=ways \
        ...
        --used-node  inPipe.0=ways      idTrackerType=Dynamic  \
    ...
    --read-pbf "$OSMFILE" outPipe.0=relations \
        ...
        --used-way   inPipe.0=relations outPipe.0=relations idTrackerType=Dynamic \
        --used-node  inPipe.0=relations idTrackerType=Dynamic \
    --read-pbf "$OSMFILE" outPipe.0=platforms \
        --tag-filter inPipe.0=platforms outPipe.0=platforms  accept-relations highway=platform \
        --used-way   inPipe.0=platforms outPipe.0=platforms idTrackerType=Dynamic \
        --used-node  inPipe.0=platforms idTrackerType=Dynamic \
